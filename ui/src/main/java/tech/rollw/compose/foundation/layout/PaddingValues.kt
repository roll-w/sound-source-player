...
package tech.rollw.compose.foundation.layout
...
private class CopiedPaddingValues(
    ...
    override fun toString(): String {
        return "PaddingValues.Copied($start, $top, $end, $bottom, $paddingValues)"
    }
}

@Composable
fun PaddingValues.offset(all: Dp = 0.dp): PaddingValues = offset(all, all, all, all)
...
private class OffsetPaddingValues(
    ...
    override fun toString(): String {
        return "PaddingValues.Offset($start, $top, $end, $bottom, $paddingValues)"
    }
}